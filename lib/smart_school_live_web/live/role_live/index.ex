defmodule SmartSchoolLiveWeb.RoleLive.Index do
  use SmartSchoolLiveWeb, :live_view

  alias SmartSchoolLive.Roles
  alias SmartSchoolLive.Roles.Role
  ...
  @impl true
  def handle_info({SmartSchoolLiveWeb.RoleLive.FormComponent, {:saved, role}}, socket) do
